...
func init() {
	...
	protocolNameToType["doubao"] = Doubao
	// Keep the historical realtime protocol name as a volcengine alias.
	protocolNameToType["volcengine-realtime"] = Doubao
}
